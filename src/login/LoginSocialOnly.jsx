  ...
  return (
    <div className="mt-14 md:mt-16 container xl:px-0 px-4 relative z-50">
      ...
      <form className="px-6 sm:px-8 md:px-10 lg:px-[52px] py-6 lg:py-7 rounded-[3px] bg-dark-400 border-[2px] border-dark-800 w-full max-w-[500px] mx-auto mt-5 md:mt-9">
        ...
        <div className="flex items-center justify-center mt-4 sm:mt-8 leading-133 text-lg text-white font-normal">
          Have an account?&nbsp;{" "}
          <Link to="/create-company" className="text-primary font-bold">
            Login
          </Link>
        </div>
      </form>
